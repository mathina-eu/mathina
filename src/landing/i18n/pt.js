export default {
  landing: {
    ...
    firstSection: '<h1 class="title">Mathina promove o pensamento matemático por meio do desenvolvimento, implementação ' +
      ...
      'personagens fictícias envolvidas em aventuras matemáticas. As histórias apresentam conceitos, desafios e jogos ' +
      'com os quais o utilizador pode interagir, refletir e aprender.</p>' +
      '<p>Mathina pode ser usado pelos pais para jogar com os seus filhos, pelos professores como uma ferramenta ' +
      'didática ou diretamente pelos jovens alunos desejosos de descobrir mais Matemática, reforçando a ligação entre ' +
    ...
    secondSection: '<p>O projeto Mathina oferece os seguintes materiais para alunos, pais e educadores:</p>' +
      ...
      'Mathina’s World</a></strong> (pdf), uma apresentação dos objetivos pedagógicos de Mathina, para pais e ' +
      'educadores. Porquê histórias de ficção? Porquê estes tópicos específicos de Matemática? Porquê explorar ' +
      'Mathina com os seus filhos?</li>' +
      '<li>O <strong><a href="/documents/handbook_mathina_por.pdf" target="_blank">Manual para educadores</a></strong> ' +
      '(pdf), com materiais, explicações e recursos adicionais.</li>' +
      '</ul>' +
    ...
    closingSectionText: 'O Projeto Mathina foi criado no âmbito de um ' +
      ...
      'target="_blank">Projeto Erasmus+</a> entre 2018 e 2021, financiado pela Comissão Europeia. Cinco parceiros ' +
      'colaboraram na criação do projeto Mathina:',
    footerSection: '<h1 class="title">Os Recursos Educacionais desenvolvidos dentro de Mathina são publicados sob ' +
      'licenças livres e abertas (Creative Commons BY-NC-SA, Apache 2.0).</h1>' +
