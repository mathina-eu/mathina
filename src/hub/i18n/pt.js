export default {
  edu: {
    'mathina-educators-repository': 'Mathina - Repositório para os Educadores',
  },
  city: {
  ...
  contributors: {
    ...
    partners: 'Parceiros',
    partnerInfo: {
      imaginary: 'IMAGINARY gGmbH (Alemanha) (Coordenador do projeto)',
      atractor: 'Atractor (Portugal)',
      curvilinea: 'Curvilinea Società Cooperativa (Itália)',
    ...
    projectManagementConsultant: 'Consultoria de gestão do projeto',
    stories: 'Histórias',
    eduOnlineGuide: 'Repositório para os educadores',
    appDevelopment: 'Desenvolvimento das apps',
    programBooklet: 'Brochura do programa Mathina',
    eduHandbook: 'Manual para os educadores',
    focusGroups: 'Testes envolvendo os grupos-foco',
    imagesAndVideo: 'Produção de imagens e vídeos',
    mathProblemCollection: 'Recolha de problemas matemáticos para as histórias',
    platformDevelopment: 'Desenvolvimento da plataforma',
    translatorsDe: 'Traduções para alemão',
    translatorsPt: 'Traduções para português',
    translatorsIt: 'Traduções para italiano',
    art: 'Arte & ilustrações',
    erasmus: {
      project: 'Mathina é um projeto Erasmus+, financiado pela Comissão Europeia',
      reference: 'Referência do projeto Erasmus+ Mathina',
    }
  },
};
