...
function render(DataPols) {
    ...
    { RangeVal += 0.4;
	   ...
	   if(RangeVal>199) {isRotating=false;pauseRotateButton.innerHTML="Animar";RangeVal=0}
    }
...
{if(pauseRotateButton.innerHTML=="Stop Animation") 
{isRotating=false;
 pauseRotateButton.innerHTML="Animate"} 
else 
{isRotating=true;
pauseRotateButton.innerHTML="Stop Animation"};}
