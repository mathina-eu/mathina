...
In the story, an example of a non convex polyhedron is found by chance, when Leo tries to close a vehicle of a Polyhedron Carousel and [some of the vehicle components turn inward](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg1).
...
`*` the [**dihedral angles**](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg2), i.e. the angles between contiguous faces, are equal;

`*` the [**solid angles**](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg3) at each vertex are equal.
...
[**cube net**](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg4)
...
[They easily conclude that this is not possible.](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg5)

So, they decide to move on to triangles, which must be equilateral (according to the properties mentioned above).

Following the same approach as before, the characters consider the case of 3 triangles joining in each vertex. By doing so, they discover a second Platonic Solid: the [**tetrahedron**](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg6).

Passing to 4 triangles in each vertex, the characters build another Platonic Solid: the [**octahedron**](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg7). Finally, by choosing 5 triangles in each vertex, they find the [**icosahedron**](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg8).

After concluding that it is not possible to build Platonic solids with more than 5 triangles in each vertex, the characters move on to [**regular pentagons**](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg9). Again, by joining 3 polygons in each vertex, Leo and Mathina find a new Platonic Solid: the [**dodecahedron**](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg10).

Leo and Mathina soon conclude that not only it is impossible to build Platonic solids with more than 3 pentagons at each vertex, but it is also impossible to build Platonic solids by [**using polygons with more than 5 sides**](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg11). Thus, they have discovered all the [**Platonic Solids**](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg12).
...
**Remark 2**: If we remove the condition “at each vertex arrive the same number of faces”, we can also get non Platonic Solids, as shown in [Game 4](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg13).

## Uniform Polyhedra

What is a uniform polyhedron? Examining a uniform polyhedron, the cuboctahedron, Mathina guesses it is a polyhedron whose faces are all regular polygons, but not all with the same number of sides, and for which [the solid angles at each vertex are equal](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg14).
...
In the story, a **polyhedron symmetry** is defined as an isometry (i.e. a function that preserves distances) that takes the polyhedron onto itself. For further information on the subject, please consult: 1) [the given examples](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg20), and 2) the “What is a symmetry?” chapter presented in the text about the story ["Stamping friezes"](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg21).

Why is the Miller polyhedron non uniform? If we consider vertices *A* and *B*, any isometry taking *A* into *B* will remove the ring of squares from the equator, thus [changing the final aspect of the polyhedron](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg22).
...
However if we [rotate the octagonal dome on the top of the Miller polyhedron by 45º](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg23), we get a new uniform polyhedron: the small rhombicuboctahedron.

Throughout the story, the characters get acquainted with **all uniform polyhedra**: 1) an infinite family of prisms, [whose bases are regular polygons and whose side faces are squares](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg24); 2) an infinite family of anti-prisms, [whose bases are regular polygons and whose side faces are equilateral triangles](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg25); 3) other 13 polyhedron:

![Uniform polyhedra](/stories/symm-4/img/_align-center_/uniformes.png =675x400)

In the end, the characters build a model for the [“Platonic and uniform polyhedra” carousel](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg26). It consists of highly symmetrical polyhedra: in fact, for each polyhedron, and for each pair of vertices, there is at least one symmetry of the polyhedron which takes one vertex onto the other.
...
## [Game 1 - Separating convex polyhedra](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg27)
...
## [Game 2 - Choosing the right nets for the cube](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg28)
...
## [Game 3 - Choosing the right nets for the octahedron](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg29)
...
## [Game 4 - Choosing non Platonic polyhedra whose faces are all regular and equal polygons](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg30)
...
## [Game 5 - Separating uniform polyhedra](https://mathina-hub.netlify.app/story/the-polyhedron-carousel/?actionLink=tg31)
